...
PDF_DATES = {
    ...
    "Thesis": datetime.datetime(2026, 9, 21, 6, 48, 41, tzinfo=UTC),
    "Open_Letter": datetime.datetime(2026, 9, 21, 6, 48, 41, tzinfo=UTC),
}
...
h2(d, "01. Thesis")
body(d, "My background includes hands-on mechanical work, construction and fabrication, routed audio systems, paid mixed-system troubleshooting at Level99, and electrical education. I am now making a deliberate transition into robotics, drawing on that experience and subsequent AI-assisted technical project work.")
body(d, "My audio work involved tracing signal paths and routing. A complex audio system is not a collection of independent devices. It is a hierarchy of sources, signal paths, transformations, control signals, interfaces, routing decisions, dependencies, feedback, and consequences. Troubleshooting means understanding the topology well enough to ask the right questions in the right order: Where did the signal originate? What should happen to it next? What transformed it? What controls that transformation? Which path was selected? Where did the observed behavior first diverge from the expected behavior?")
body(d, "Signal-path tracing is a method I can apply to troubleshooting across systems.")
...
body(d, "At Level99, my paid Venue Technician work involved troubleshooting and maintaining interactive systems involving RFID and other sensors, PLC-monitored elements, DMX, Arduino hardware, programmable LEDs, audio, mechanical components, and computer control. I used PLC monitoring interfaces to observe states and test sensors; software personnel handled ladder logic. The important lesson was not any one technology. It was the interaction between them. Physical state, sensing, logic, communication, control, and human-visible behavior all had to agree.")
body(d, "At the Starlink facility in Bastrop, Texas, I built clean-room structures for PCB manufacturing. I later completed Martin Electrical School's Journeyman One program, studying electrical theory, code, and safety.")
body(d, "My current technical project work uses AI assistance. I direct and review work, define acceptance criteria, and use tests and recorded evidence to check results. Signal-path reasoning is useful here for examining inputs, transformations, dependencies, and failures; the project artifacts show what has actually been checked.")
body(d, "These are methods I want to bring to robotics build and test work.")
...
body(d, "I am choosing robotics as my next direction because it brings these systems together. My existing experience can support build, maintenance, and troubleshooting work while I develop the robotics-specific knowledge I still need.")
...
body(d, "Background informing my robotics transition: Mechanical troubleshooting; construction / fabrication; routed audio systems; Level99 troubleshooting; electrical education; AI-assisted project work; current robotics transition.")

h2(d, "04. What I am bringing into robotics")
body(d, "I am not presenting myself as an experienced robotics engineer, embedded-firmware specialist, controls engineer, or someone with years of professional autonomy development. What I can bring immediately is a different combination: hands-on fabrication and welding experience; mechanical and automotive troubleshooting; experience using tools and equipment in real physical environments; electrical fundamentals and formal electrical study; sensor and interactive-system troubleshooting experience; deep familiarity with signal-path reasoning from audio engineering; software and AI systems thinking; comfort learning across domain boundaries; and a strong bias toward tracing causes rather than treating symptoms.")
...
body(d, "I now bring together mechanical troubleshooting, construction and fabrication, routed audio work, Level99 maintenance, and electrical education as I pursue robotics technician work. My subsequent AI-assisted projects add work on requirements, tests, and evidence, with their limits stated alongside the results.")
...
paras = [
    ...
    "I am making a deliberate transition into robotics, bringing experience in mechanical troubleshooting, construction and fabrication, routed audio systems, mixed-system maintenance, and electrical study.",
    "In audio work, I traced signal chains through sources, processing, routing and control points, looking for where the observed output differed from what I expected.",
    ...
    "Tracing a fault through connected components is useful in mechanical and venue-system troubleshooting as well as audio.",
    ...
    "At Level99, my paid Venue Technician work involved troubleshooting and maintaining interactive systems combining RFID and other sensors, PLC-monitored elements, DMX, Arduino hardware, programmable LEDs, audio, mechanical components, and computer control. I used PLC monitoring interfaces to observe states and test sensors; software personnel handled ladder logic. The important part was not any one technology. It was the interaction between them.",
    "At the Starlink facility in Bastrop, Texas, I built clean-room structures for PCB manufacturing. I later completed Martin Electrical School's Journeyman One program, adding formal electrical theory, code, and safety to a technical foundation that had already been developing through mechanical work, fabrication, troubleshooting, and systems thinking.",
    "My current technical project work uses AI assistance. I direct and review work, define acceptance criteria, and use tests and recorded evidence to check results. Signal-path reasoning is useful here for examining inputs, transformations, dependencies, and failures; the project artifacts show what has actually been checked.",
    "I now bring together mechanical troubleshooting, construction and fabrication, routed audio work, Level99 maintenance, and electrical education as I pursue robotics technician work. My subsequent AI-assisted projects add work on requirements, tests, and evidence, with their limits stated alongside the results.",
    ...
    "What I can bring immediately is hands-on fabrication and welding experience, mechanical troubleshooting, electrical fundamentals, hands-on troubleshooting of sensor-driven interactive systems, comfort with tools and equipment, signal-path reasoning from audio engineering, software and AI systems thinking, and a strong habit of tracing causes across domain boundaries.",
...
for p in paras:
    if p.startswith("I am not presenting myself"):
        d.add_page()  # Keep the closing scope and contribution paragraphs together.
    body(d, p)
d.set_font("Helvetica", "B", 10.5)
